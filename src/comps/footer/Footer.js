...
import './Footer.css'
import {navbarItems, navbarAccounts} from '../helpers/Data'

class Footer extends Component
{
	displayNavbarItems = _ =>
	{
		let items = navbarItems.map(item =>
		{
			return (
	...
	displayNavbarAccounts = _ =>
	{
		let accounts = ['Facebook', 'Instagram', 'Twitter']
		let items = navbarAccounts.map((item, index) =>
		{
			return (
					...
					<div className = 'row'>
						<div className = 'c col-lg-4 col-12 my-auto'>
							<div className = 's first-side text-lg-start text-center mb-lg-0 mb-5'>
								<div className = 'first-sub-side'>
									<h3 className = 'brand-name mb-3' ><span>H</span>orizon</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
								</div>
								<div className = 'second-sub-side'>
									<p className="small text-muted mb-0">&copy; Copyrights. All rights reserved. <a href="#">Horizon</a></p>
								</div>
							</div>
						</div>
						...
						<div className = 'c col-lg-4 col-12 my-auto'>
							<div className = 's fourth-section text-lg-start text-center mb-lg-0 mb-5'>
								<p className = 'text-capitalize lh-2'>this website has been created and designed by <span className = "owner">Horizon</span> also known as<span className = "owner"> Horizon Logos </span>
	                		, and published on <span className = "year">2022</span></p>
							</div>
						</div>
					</div>
				</div>
